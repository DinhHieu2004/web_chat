...
export default function MessageItem({
  ...
  const buildPreviewForForward = (m) => {
    ...
    const { lat, lng } =
      m?.type === "location" ? extractLatLng(m) : { lat: null, lng: null };
    ...
    if (finalType === "forward") {
      ...
      return (
        <div className="flex flex-col gap-2">
          ...
          {pvType !== "emoji" &&
            pvType !== "richText" &&
            !["sticker", "gif", "image", "video", "audio", "file"].includes(
              pvType
            ) &&
        ...
        <div className="flex flex-col gap-3 min-w-[280px]">
          ...
          <div className="flex flex-col gap-2">
            {poll.options.map((opt) => {
              ...
              const totalVotersCount = poll.options.reduce(
                ...
                >
                  ...
                  <div
                    className={`absolute left-0 top-0 h-full transition-all ${
                      isVotedByMe ? "bg-white/20" : "bg-purple-200"
                    }`}
                  ...
                  <div className="relative flex items-center gap-2 flex-1">
                    {isVotedByMe && <span className="text-lg">✓</span>}
          ...
          <div className="text-xs text-gray-500 flex items-center justify-between pt-1 border-t border-gray-200">
            <span>
              {totalVotes}{" "}
              {totalVotes === 1 ? "lượt bình chọn" : "lượt bình chọn"}
            </span>
            {hasVoted && (
