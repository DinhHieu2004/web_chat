    ...
    return (
        ...
        >
            <div className="relative">
                <div
                    className="w-12 h-12 bg-linear-to-br from-purple-400 to-blue-400 rounded-full flex items-center justify-center text-2xl">
                    {contact.avatar}
                </div>
                {contact.online && (
                    <div
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between">
                    ...
                    {contact.unread > 0 && (
                        <span
                            className="bg-purple-500 text-white text-xs rounded-full px-2 py-0.5 ml-2">{contact.unread}</span>
                    )}
                </div>
